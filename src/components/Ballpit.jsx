// Full fidelity Ballpit component restored from original first page/Ballpit.js
// Provides interactive instanced spheres with physics. Keep verbatim for parity.
...
function createBallpit(e, t = {}) {
  ...
  i.renderer.setClearColor('black');
